  ...
  <body>
    ...
    <section id="product__item" class="product">
      ...
      <div class="product__container container">
        ...
        $sql = "SELECT `ID`, `productName`, `productType`, `productDescription`, `productPrice`, `productPhoto` FROM `products` WHERE `productType`='камера' ORDER BY `ID` DESC";
          ...
          foreach($result as $row){
              ...
              <div class="product__item-txt">
                ...
                <div class="product__item-group">
                    ...
                    <form class="form__delete" action="cameras.php#product__item" method="POST">

  ...
  <body>
    ...
    <section class="hero">
      ...
      <div class="hero__container container">
        <h1>
          камеры.<br />
          объективы.<br />
          <span style="color: red">аксессуары.</span>
        </h1>
    ...
    <section id="product__item" class="product">
      ...
      <div class="product__container container">
        ...
        $sql = "SELECT `ID`, `productName`, `productType`, `productDescription`, `productPrice`, `productPhoto` FROM `products` WHERE `productType`='аксессуар' ORDER BY `ID` DESC";
          ...
          foreach($result as $row){
              ...
              <div class="product__item-txt">
                ...
                <div class="product__item-group">
                    ...
                    <form class="form__delete" action="accessory.php#product__item" method="POST">
